...
public class ResultFragment extends Fragment {
    ...
    private void init() {
        ...
        rtButton = view.findViewById(R.id.rotate);
        rtButton.setOnClickListener(new RTButtonClickListener());
    ...
    private class RTButtonClickListener implements View.OnClickListener {
        @Override
        public void onClick(final View v) {
            showProgressDialog(getResources().getString(R.string.rotating_image));
            AsyncTask.execute(new Runnable() {
                @Override
                public void run() {
                    try {
                        ...
                        matrix.postRotate(CURR_ROTATION);
                        CURR_ROTATION += 90;

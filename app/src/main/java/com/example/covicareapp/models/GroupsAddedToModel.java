...
public class GroupsAddedToModel {
    String createdBy, groupInfo, groupName, groupId;
    Timestamp dateCreated;
    ArrayList<String> groupUsers;

    public GroupsAddedToModel() {
    }

    public GroupsAddedToModel(String createdBy, String groupInfo, String groupName, String groupId, Timestamp dateCreated, ArrayList<String> groupUsers) {
